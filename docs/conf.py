...
htmlhelp_basename = 'openopenmmreportersdoc'
...
latex_documents = [
    (master_doc, 'openopenmmreporters.tex', 'OpenOpenMMReporters Documentation',
     'openopenmmreporters', 'manual'),
]
...
man_pages = [
    (master_doc, 'openopenmmreporters', 'OpenOpenMMReporters Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'openopenmmreporters', 'OpenOpenMMReporters Documentation',
     author, 'openopenmmreporters', 'A short description of the project.',
     'Miscellaneous'),
]
